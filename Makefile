...
.PHONY: clean demo
#Targets
all: main.o record.o records.o WelcomePage.o report.o user.o user_account.o validation.o
	mkdir -p Release
...
records.o: records.cpp records.h
	$(CXX) $(CXXFLAGS) -c $< -o $@
WelcomePage.o: WelcomePage.cpp WelcomePage.h Homepage.cpp RecordEditor.cpp ui_tools.cpp SearchSortRecords.cpp Settings.cpp Stat.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
