...
void printRecord(Records *userRecords)
{
    ...
    cout << left << setw(4) << "ID" << setw(25) << "DATE"
	 << " " << setw(18) << left << "ACCOUNT" << setw(18) << left << "CATEGORY" << setw(16) << left << "AMOUNT" << setw(8) << "TYPE" << setw(10) << "REMARK" << endl;
    cout << string(4 + 25 + 18 + 18 + 16 + 8 + 10, '-') << endl;
    for (unsigned int i = 0; i < userRecords->countRecord(); i++)
	{
	    Record *r = userRecords->getRecord(i);
	    cout << left << setw(4) << r->getID() << setw(25) << r->getDate() << " " << setw(18) << left << r->getAccount() << setw(18) << left << r->getCategory() << setw(2) << "$" << setw(13) << right << fixed << setprecision(2) << r->getAmount() << " " << left << setw(8) << r->getType()
		 << r->getRemark() << endl;
	}
    cout << endl;
}
...
void printAccountMonthlyReport(User *user)
{
    ...
    cout << left << setw(4) << "ID" << setw(25) << "DATE"
	 << " " << setw(18) << left << "ACCOUNT" << setw(18) << left << "CATEGORY" << setw(15) << left << "INCOME" << setw(15) << left << "EXPENSE" << endl;
    cout << "---------------------------------------------------------------------------------------------" << endl;
